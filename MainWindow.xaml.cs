...
namespace Calender
{
    public partial class MainWindow : Window 
    {
        ...
        private List<Reminder> FilterRemindersByDate(DateTime selectedDate)
        {
            return Reminders.Where(reminder => reminder.Date.Date == selectedDate.Date).ToList();
        }

        private void FilterRemindersBySelectedDate()
        {
        ...
        {
            ObservableCollection<Reminder> reminders = GetReminder();
...
//public class ReminderReload : INotifyPropertyChanged
//{
//    private int id;
//    public int Id
//    {
...
//    {
//        public ObservableCollection<ReminderReload> Reminders { get; } = new ObservableCollection<ReminderReload>();
//    }
